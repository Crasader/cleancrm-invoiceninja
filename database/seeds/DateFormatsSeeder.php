...
class DateFormatsSeeder extends Seeder
{
    public function run()
    {
        ...
        $formats = [
            ...
            [
                'format' => 'j. M. Y',
                'picker_format' => 'd. M. yyyy',
                'format_moment' => 'DD. MMM. YYYY',
                'format_dart' => 'd. MMM. yyyy'
            ],
            [
                'format' => 'j. F Y',
                'picker_format' => 'd. MM yyyy',
                'format_moment' => 'DD. MMMM YYYY',
